...
def upgrade():
    ...
    op.create_table('meta',
                    ...
                    sa.Column('type', sa.Enum('disciplines', 'branches',
                              'tags', name='types'), nullable=True),
    ...
    op.create_index(op.f('ix_companies_meta_company_id'),
                    'companies_meta', ['company_id'], unique=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_companies_meta_company_id'),
                  table_name='companies_meta')

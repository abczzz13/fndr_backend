...
Revision ID: 67435d8c3ed4
Revises: b45931cd3c0a
Create Date: 2022-04-07 17:31:57.830347
...
revision = '67435d8c3ed4'
down_revision = 'b45931cd3c0a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('city_lat', sa.Float(precision=8), nullable=True),
    sa.Column('city_lng', sa.Float(precision=8), nullable=True),

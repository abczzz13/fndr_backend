"""Made changes to enums

Revision ID: e727ac4930fb
Revises: 
Create Date: 2022-02-25 09:17:16.636754
...
def upgrade():
    ...
    sa.Column('region', sa.Enum('Unknown', 'Drenthe', 'Flevoland', 'Friesland', 'Gelderland', 'Groningen', 'Limburg', 'Noord-Brabant', 'Noord-Holland', 'Overijssel', 'Utrecht', 'Zuid-Holland', 'Zeeland', name='regions'), nullable=True),
    ...
    sa.Column('company_size', sa.Enum('Unknown', '1-10', '11-50', '51-100', 'GT-100', name='sizes'), nullable=True),
